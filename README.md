...
서비스의 메인 화면입니다. 수강신청 시작까지 남은 시간을 카운트다운으로 확인할 수 있고, 공지사항과 주간 리더보드 상위 랭커를 한눈에 볼 수 있습니다.
...
강좌명, 교수명, 학수번호 등으로 강좌를 검색할 수 있습니다. 장바구니에 담기 전 시간표 충돌 여부를 자동으로 검사하여 겹치는 강좌가 있으면 경고를 표시합니다.
...
수강신청할 강좌를 미리 담아둘 수 있습니다. 드래그 앤 드롭으로 신청 순서를 변경할 수 있으며, 우측 시간표에서 담은 강좌들의 시간 배치를 미리 확인할 수 있습니다.
...
- 설정한 시간에 맞춰 타이머가 시작됩니다
- Picture-in-Picture(PiP) 기능으로 다른 작업 중에도 타이머를 확인할 수 있습니다
...
```bash
# .env
VITE_API_URL=https://allclear.codes/
