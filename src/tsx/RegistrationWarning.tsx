    ...
    <div className='background'>
      <div className='warningContainer'>
        <div className='contentWrapper'>
          ...
          <p className='warningText'>{getMessage(warningType)}</p>
        </div>
    ...
    <div className='background'>
      <div className='waiting-modal-box'>
        ...
        <div className='waiting-info-text'>
          고객님 앞에 <strong>{Math.floor(queueInfo.count)}명</strong>의
          대기자가 있습니다.
          <br />
    ...
    <div className='background'>
      <div className='warningContainer'>
        <div className='success-header'>
          <h2 className='success-title'>수강신청되었습니다.</h2>
          <p className='success-desc'>
            지금 바로 수강신청내역으로 이동하시겠습니까?
          </p>
        </div>
        <div className='success-btn-row'>
          <button className='success-btn gray' onClick={onKeep}>
            수강신청 계속하기
          </button>
          <button className='success-btn blue' onClick={onGoToHistory}>
            수강신청내역으로 이동
          </button>
        </div>
      </div>
