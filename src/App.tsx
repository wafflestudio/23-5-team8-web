          ...
          <div className='homeCol leftCol'>
              ...
              <div className='periodBody'>
                <table className='periodTable'>
                  ...
                  <tbody>
                    <tr>
                      <td>수강취소(개강후)</td>
                      <td>2025-12-22(월) ~ 2026-01-08(목)</td>
                      <td>00:00~23:59</td>
            ...
            <section className='panel infoPanel'>
              ...
              <div className='panelBody infoBody'>
                ...
                <div className='infoLine'>
                  자세한 사항은 mySNU 포털 공지사항 혹은 수강신청사이트
                  공지사항을 참고해 주시기 바랍니다.
                </div>
              </div>
            </section>
...
function LoginPage() {
  return (
    <main className='page'>
      <div className='containerX'>
        <div className='loginRouteWrap'>
          <h2 className='loginRouteTitle'>Login</h2>
          <div className='loginRouteHint'>src/login.tsx로 교체하면 됩니다.</div>
        </div>
      </div>
    </main>
  );
